...
<div class="tip"><input class="userName" name="userName" type="text" id="userName" title="用户名" iscookie="true" value="hxhg" nullmsg="请输入用户名!" /></div>
...
<div class="clear"></div>
<div id="versionBar">
<div class="copyright">&copy; 版权所有 <span class="tip"><a href="#" title="">新疆师范大学计算机科学技术学院</a> (推荐使用IE8+,谷歌浏览器可以获得更快,更安全的页面响应速度)技术支持:15894720782<a href="#" title=""></a></span></div>
</div>
<!-- Link JScript-->
